 ...
 * @date On 2021/2/28
 */
public class SystemTreeDetailPagerAdapter extends FragmentPagerAdapter {

    private List<BaseFragment> mBaseFragments;
    private List<String> mTitles;

    public SystemTreeDetailPagerAdapter(@NonNull FragmentManager fm, List<BaseFragment> baseFragments, List<String> titles) {
        super(fm);
