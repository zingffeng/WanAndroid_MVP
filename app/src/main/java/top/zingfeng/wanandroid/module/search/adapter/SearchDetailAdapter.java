 ...
 * @date On 2021/2/20
 */
public class SearchDetailAdapter extends BaseQuickAdapter<SearchQueryDataBean.DataBean.DatasBean, BaseViewHolder> {

    public SearchDetailAdapter(int layoutResId, @Nullable List<SearchQueryDataBean.DataBean.DatasBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, SearchQueryDataBean.DataBean.DatasBean datasBean) {
